...
if restart:
    _ = bs.powrun(boundary[0], boundary[1], 5, receptor, ligand, iso=iso, dist = dist, log=logfile, angle=angle, axisx=0.05, axisy=0.05, axisz=1.0, no_samples=no_samples, file_name = name, tcl =tcl, restart = True, ensemble_module = 'generate_ensemble_mem.py')
else:
    _ = bs.powrun(boundary[0], boundary[1], 5, receptor, ligand, iso=iso, dist = dist, log=logfile, angle=angle, axisx=0.05, axisy=0.05, axisz=1.0, no_samples=no_samples, file_name = name, tcl =tcl, ensemble_module = 'generate_ensemble_mem.py')    
